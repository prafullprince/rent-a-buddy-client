...
export default function IntergalacticSpinner() {
  return (
    <div className="flex items-center justify-center bg-gradient-to-br from-black via-indigo-900 to-black">
      <div className="relative w-6 h-6" style={{ perspective: 1000 }}>
        {/* Glowing Core Planet */}
        <motion.div
